        ...
        .then((json) => {
            ...
            <div class="listing-card" data-href="http://localhost:63342/SpringCarrot/src/product_detail/listingDetail.html?_ijt=l9b8sppmmoqv4418ujei8ivt66&_ij_reload=RELOAD_ON_SAVE&id=${json[i].id}">
                ...
                <div class="flex flex-row-reverse">
                    ...
                    <button class="inline-block mb-2 listing-to-list justify-center items-center listing-later-button" data-value="${listing.id}" style="width: 50%;  z-index: 3"><i class="fa-solid fa-star" style="color: white" data-value="${listing.id}"></i></button>                  
